...
// Author: Daniel Long
// Course: ICS4U1.
// Description: This class provides custom UI to JComboBoxes that removes some unwanted visual artifacts (border around popup, unusual double borders around the button next to the down-arrow).
//
///////////////////////
